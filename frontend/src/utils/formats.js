...
const FORMAT_MAP = {
  ...
  json: ['csv', 'xml', 'yaml', 'html', 'txt', 'toml', 'ini', 'sql', 'xlsx', 'parquet'],
  csv: ['json', 'tsv', 'txt', 'html', 'xml', 'yaml', 'xlsx', 'sql', 'parquet', 'feather'],
  tsv: ['csv', 'json', 'xlsx'],
  xml: ['json', 'csv', 'yaml', 'txt', 'sql'],
  yaml: ['json', 'xml', 'toml', 'txt'],
  toml: ['json', 'yaml', 'txt'],
